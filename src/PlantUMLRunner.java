...
public class PlantUMLRunner {
    ...
    public static void generate(String data, String path, String fileName) {//wygenerowany schemat po przekazaniu
        try {
            ...
            FileWriter writer = new FileWriter(filePath);//jest nieobsluzony wyjatek wiec trzeba dodac albo try catch albo do sygnayuty metode
